<?php
    ...
    function get_lunch($code, $type)
    {
        ...
        {
            $url = "https://stu.goe.go.kr/sts_sci_md00_001.do?schulCode=".$code."&schulCrseScCode=3&ay=".date("Y", strtotime("+1 day"))."&mm=".date("m", strtotime("+1 day"));
            $next = true;
        }
        else
            $url = "https://stu.goe.go.kr/sts_sci_md00_001.do?schulCode=".$code."&schulCrseScCode=3";
